...
meta() %>%
  meta_general(
    description = "The first presentation of the NCSA-CCSSO 2022 Session on COVID-19 Academic Impact and Recovery",
  ...
  meta_social(
    ...
    image = "https://centerforassessment.github.io/NCSA_CCSSO_2022_Covid_19_Impact/Figures/TITLE_SLIDE_image.png",
